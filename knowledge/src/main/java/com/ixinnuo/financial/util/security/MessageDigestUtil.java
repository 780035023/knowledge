...
public class MessageDigestUtil {
	...
	public static void main(String[] args) throws Exception {
		// listAlgorithm();
		System.out.println("md5:" + messageDigest("你好", Algorithm_MD5));
		System.out.println("sha1:" + messageDigest("你好", Algorithm_SHA1));
	 ...
	 *         MD5 :16个长度的字节，即16*8=128位二进制；与十六进制运算得到32位小写字符串,如果需要16位，自行截取8-24，
	 *         即去掉首位各8位长度<br/>
	 ...
	 * @return 经过十六进制换算处理的字符串<br/>
	 *         hmacMD5
	 *         :16个长度的字节，即16*8=128位二进制；与十六进制运算得到32位小写字符串,如果需要16位，自行截取8-24，
	 *         即去掉首位各8位长度<br/>
